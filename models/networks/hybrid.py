...
"""
file: hybrid.py
description: hybridgan implementation for [arXiv/1701.05927]
...
def discriminator():
    ...
    dnn_out = merge([dnn(image), cnn(image)], mode='concat', concat_axis=-1)
...
def generator(latent_size, return_intermediate=False):
    ...
    fake_image = merge([loc(h), spread(h)], mode='ave')
