...
FASTJET_BEGIN_NAMESPACE // defined in fastjet/internal/base.hh
    ...
    // WinnerTakeAllRecombiner defines a new recombination scheme by inheriting
    // from JetDefinition::Recombiner.
    // This scheme compares the energy of two input particles, and then combines
    // them into a particle with
    // an energy equal to the sum of the two particle energies and a direction
    // identical to that of the harder
    // particle. This creates a jet with an axis guaranteed to align with a
    // particle in the event.
    class WinnerTakeAllRecombiner : public fastjet::JetDefinition::Recombiner {
      public:
        // Constructor to choose value of alpha (defaulted to 1 for normal pT
        // sum)
